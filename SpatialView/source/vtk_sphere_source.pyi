...
class VtkSphereSource:
    ...
    @property
    def endPhiMax(self) -> float: ...
    @property
    def endPhiMin(self) -> float: ...
    @property
    def endTheta(self) -> float: ...
    @endTheta.setter
    def endTheta(self, value: float): ...
    @property
    def endThetaMax(self) -> float: ...
    @property
    def endThetaMin(self) -> float: ...
    @property
    def startPhi(self) -> float: ...
    @property
    def startPhiMax(self) -> float: ...
    @property
    def startPhiMin(self) -> float: ...
    @startPhi.setter
    def startPhi(self, value: float): ...
    @property
    def startTheta(self) -> float: ...
    @property
    def startThetaMax(self) -> float: ...
    @property
    def startThetaMin(self) -> float: ...
    @startTheta.setter
    def startTheta(self, value: float): ...
    @property
    def phiResolution(self) -> int: ...
    @property
    def phiResolutionMax(self) -> float: ...
    @property
    def phiResolutionMin(self) -> float: ...
    @phiResolution.setter
    def phiResolution(self, value: int): ...
    @property
    def thetaResolution(self) -> int: ...
    @property
    def thetaResolutionMax(self) -> int: ...
    @property
    def thetaResolutionMin(self) -> int: ...
